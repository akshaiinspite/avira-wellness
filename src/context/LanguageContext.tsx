...
const translations: Record<Language, Record<string, string>> = {
  ...
  ml: {
    ...
    hero_badge4: 'ആക്സസ് ബാർസ്® & ഫാമിലി കോൺസ്റ്റലേഷൻ',

    // Welcome
    welcome_tag: 'ആവിരയിലേക്ക് സ്വാഗതം',
    welcome_title: 'ആത്മപരിശോധനയ്ക്കും സ്വയം തിരിച്ചറിവിനുമുള്ള സുരക്ഷിത ഇടം',
    welcome_desc1: 'ആവിരയിൽ, അർത്ഥവത്തായ ക്ഷേമം ആരംഭിക്കുന്നത് സ്വയം മനസ്സിലാക്കുന്നതിലൂടെയാണെന്ന് ഞങ്ങൾ വിശ്വസിക്കുന്നു. ജീവിതത്തിൽ മാനസിക സമ്മർദ്ദവും വൈകാരിക ബുദ്ധിമുട്ടുകളും ബന്ധങ്ങളിലെ അസ്വസ്ഥതകളും അനുഭവപ്പെടാം.',
    welcome_desc2: 'വ്യക്തികൾക്ക് ശാന്തമായി ചിന്തിക്കാനും സ്വന്തം അനുഭവങ്ങളെ മനസ്സിലാക്കി പുതിയ വഴികൾ കണ്ടെത്താനുമുള്ള ഒരു സുരക്ഷിത തണലായിട്ടാണ് ആവിര രൂപകൽപ്പന ചെയ്തിരിക്കുന്നത്.',
    ...
    founder1_p1: 'അഫീഫ മാനസികാരോഗ്യം, മനസ്സിന്റെയും ശരീരത്തിന്റെയും സന്തുലിതാവസ്ഥ, ഹിപ്നോതെറാപ്പി, വ്യക്തിത്വ വികസനം എന്നിവയിൽ പ്രവർത്തിക്കുന്ന കൗൺസിലിംഗ് സൈക്കോളജിസ്റ്റാണ്.',
    ...
    founder2_p2: 'ഓരോ വ്യക്തിയും സവിശേഷമാണെന്നും ക്ഷേമത്തിലേക്ക് ഒരൊറ്റ വഴി മാത്രമല്ല ഉള്ളതെന്നും അവ വിശ്വസിക്കുന്നു.',
    ...
    about_sanc_item1: 'മനസ്സ്-ശരീര സന്തുലിതാവസ്ഥയ്ക്കുള്ള പരിശീലനങ്ങൾ',
