...
const translations: Record<Language, Record<string, string>> = {
  ...
  ml: {
    ...
    service_acu_cat: 'ശരീരത്തിന്റെയും മനസ്സിന്റെയും സന്തുലിതാവസ്ഥ',
    ...
    day_sec_p1: 'ശാന്തവും സുരക്ഷിതവുമായ അന്തരീക്ഷത്തിൽ വെൽനെസ് തെറാപ്പിസ്റ്റിനൊപ്പം ഒരു ദിവസം പൂർണ്ണമായി ചെലവഴിക്കുന്ന വ്യക്തിഗത अनुभवोंാണ് സ്വന്തം ഉള്ളിലേക്ക് ഒരു ദിവസം.',
    ...
    area6_title: 'മനസ്സിന്റെയും ശരീരത്തിന്റെയും സന്തുലിതാവസ്ഥ',
